...
export const content: Routes = [
  ...
  },
  {
    ...
    title: 'Refund & Cancellation Policy – Smooth Shopping | Kahuafashionclub'
  },
  {
    path: "Contact-Us",
  ...
  },
  {
    ...
    title: 'Terms & Conditions – Rules of Using Kahuafashionclub'
  },
  {
    path: "shipping-policy",
    loadChildren: () => import("../../shipping-delevary/shipping-delevary.module").then((m) => m.ShippingDelevaryModule),
    title: 'Shipping & Delivery Information – Fast & Safe | Kahuafashionclub'
  },
  {
    path: "auth",
