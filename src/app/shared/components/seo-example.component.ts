  ...
  template: `
    <div class="seo-example-container">
      ...
      <app-seo-heading 
        ...
        description="Discover new season shirts jackets suits denim and more at Mangalbookstore. Premium quality fast shipping across India COD and easy returns."
        level="1"
...
export class SeoExampleComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.setBreadcrumbStructuredData([
      { name: 'Home', url: 'https://Mangalbookstore.in' },
      { name: 'Featured Products', url: 'https://Mangalbookstore.in/featured' }
    ]);
  }
} 