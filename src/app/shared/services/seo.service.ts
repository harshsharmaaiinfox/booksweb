...
export class SeoService {
  ...
  setProductStructuredData(product: any): void {
    ...
    const structuredData: any = {
      ...
      "brand": {
        "@type": "Brand",
        "name": product.brand?.name || "Mangalbookstore"
      },
      "offers": {
        "@type": "Offer",
  ...
  setOrganizationStructuredData(): void {
    const structuredData = {
      "@context": "https://schema.org",
      "@type": "Organization",
      "name": "Mangal Book Store.",
      "legalName": "Mangal Book Store.",
      "url": "https://mangalbookstore.in",
      "logo": "https://mangalbookstore.in/assets/images/logo.png",
      "email": "info@mangalstore.in",
      "address": {
        "@type": "PostalAddress",
  ...
  setArticleStructuredData(article: any): void {
    const structuredData = {
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://mangalbookstore.in/assets/images/logo.png"
        }
      },
  ...
  updateDefaultSeo(): void {
    ...
    this.setSEOData({
      title: 'Mangalbookstore | Premium Ethnic & Designer Wear Online in India',
      description: 'Shop premium ethnic and designer wear at Mangalbookstore. Explore sarees, lehengas, suits, and more with fast delivery across India, COD options, and easy returns.',
      keywords: 'activewear, gym wear, joggers, men\'s clothes, women\'s clothes, stylish outfits, comfort fit, performance clothing, Mangalbookstore',
      type: 'website',
      url: 'https://mangalbookstore.in/'
    });
  }
   ...
   */
  setProductPageSEO(product: any, productSlug: string | null, baseUrl: string = 'https://mangalbookstore.in'): void {
  ...
  private generateProductTitle(product: any): string {
    ...
    // Example: "Nike Air Max 270 Men's Running Shoes - ₹8,999 | Mangalbookstore"
    return `${brand}${product.name}${category} - ${price} | Mangalbookstore`;
  }
  ...
  private generateProductDescription(product: any): string {
    ...
    let rawDescription: string = product.meta_description
      ...
      || product.description
      || `Shop ${brand}${product.name}${category} online at Mangalbookstore. Premium quality, great prices, fast delivery.${discount}`;
  ...
  private sanitizeProductDescription(text: string): string {
    ...
    if (!sanitized) {
      sanitized = 'Premium quality, great prices, fast delivery from Mangalbookstore.';
    }
  ...
  private generateProductKeywords(product: any): string {
    ...
    keywords.push('buy online', 'Mangalbookstore', 'fashion', 'clothing');
